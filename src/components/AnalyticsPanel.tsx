...
export function AnalyticsPanel({ proposal }: { proposal: Proposal }) {
  ...
  const proCluster = [...proposal.clusters].filter((c) => c.side === "for").sort((a, b) => b.members - a.members)[0];
  const conCluster = [...proposal.clusters].filter((c) => c.side === "against").sort((a, b) => b.members - a.members)[0];
  ...
  return (
    <div className="glass rounded-2xl p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="text-xs uppercase tracking-widest text-muted-foreground">Consensus Intelligence</div>
        ...
        <div className="relative w-40 h-40 shrink-0">
          <svg viewBox="0 0 160 160" className="w-full h-full -rotate-90">
            ...
            <motion.circle
              ...
              stroke={confColor} strokeWidth="10" fill="none" strokeLinecap="round"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="text-3xl font-bold" style={{ color: confColor }}>{conf}%</div>
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-center">
            <div className="rounded-lg bg-white/[0.02] border border-white/5 p-2">
              ...
              <div className="text-[10px] uppercase tracking-widest text-muted-foreground">Clusters</div>
            </div>
            <div className="rounded-lg bg-white/[0.02] border border-white/5 p-2">
      ...
      <div className="grid md:grid-cols-2 gap-3">
        {proCluster && (
          <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.04] p-4">
            <div className="text-[10px] uppercase tracking-widest text-emerald-300 mb-2">Dominant Supporting</div>
        ...
        {conCluster && (
          <div className="rounded-xl border border-red-500/20 bg-red-500/[0.04] p-4">
            <div className="text-[10px] uppercase tracking-widest text-red-300 mb-2">Dominant Opposing</div>
